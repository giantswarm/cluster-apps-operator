...
- Update `app-operator` to version `v7.5.3`.
...
- Update `app-operator` to version `v7.5.0`.

## [3.4.1] - 2025-10-02

### Changed

- Update `chart-operator` to version `v4.1.1`.

## [3.4.0] - 2025-10-02

### Changed

- Update `chart-operator` to version `v4.1.0`.

## [3.3.0] - 2025-08-14

### Changed

- Update `app-operator` to version `v7.3.0`.
- Update `chart-operator` to version `v4.0.1`.
...
[Unreleased]: https://github.com/giantswarm/cluster-apps-operator/compare/v3.9.1...HEAD
[3.9.1]: https://github.com/giantswarm/cluster-apps-operator/compare/v3.9.0...v3.9.1
...
[3.3.0]: https://github.com/giantswarm/cluster-apps-operator/compare/v3.2.0...v3.3.0
[3.2.0]: https://github.com/giantswarm/cluster-apps-operator/compare/v3.1.2...v3.2.0
[3.1.2]: https://github.com/giantswarm/cluster-apps-operator/compare/v3.1.1...v3.1.2
[3.1.1]: https://github.com/giantswarm/cluster-apps-operator/compare/v3.1.0...v3.1.1
...
[2.22.1]: https://github.com/giantswarm/cluster-apps-operator/compare/v2.22.0...v2.22.1
